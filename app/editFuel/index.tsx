...
export default function EditFuelEntryScreen() {
    ...
    const id = parseInt(params.entryId as string, 10);
        ...
        >
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                ...
                >
                    ...
                    {showDatePicker && (
                        <DateTimePicker value={fuelDate} mode="date" display="default" onChange={handleDateChange} />
                    )}
                        ...
                        <View style={styles(theme).fieldContent}>
                            ...
                            <View style={styles(theme).inputRow}>
                                <TextInput
                                    ...
                                    returnKeyType="done"
                                />
                                <TouchableOpacity style={styles(theme).unitSelector} onPress={() => setShowDistanceDropdown(true)}>
                        ...
                        <View style={styles(theme).fieldContent}>
                            ...
                            <View style={styles(theme).inputRow}>
                                <TextInput
                                    ...
                                    returnKeyType="done"
                                />
                                <TouchableOpacity style={styles(theme).unitSelector} onPress={() => setShowVolumeDropdown(true)}>
                    ...
                    <View style={styles(theme).buttonContainer}>
                        <TouchableOpacity style={styles(theme).deleteButton} onPress={handleDelete} disabled={isSaving || isDeleting}>
                            <Ionicons name="trash" size={20} color={theme.Colors.white} style={styles(theme).buttonIcon} />
                            <Text style={styles(theme).deleteButtonText}>{isDeleting ? "DELETING..." : "DELETE"}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles(theme).saveButton} onPress={handleEdit} disabled={isSaving || isDeleting}>
                            <Ionicons name="checkmark-circle" size={20} color={theme.Colors.white} style={styles(theme).buttonIcon} />
                            <Text style={styles(theme).saveButtonText}>{isSaving ? "SAVING..." : "SAVE CHANGES"}</Text>
                        </TouchableOpacity>
                    </View>
            ...
            {(isSaving || isDeleting) && (
                <Modal transparent animationType="fade">
                    <View style={styles(theme).loadingOverlay}>
                        <ActivityIndicator size="large" color={theme.Colors.primary} />
                        <Text style={styles(theme).loadingText}>{isSaving ? "Saving..." : "Deleting..."}</Text>
                    </View>
                </Modal>
            )}
